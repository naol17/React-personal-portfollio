...
export const Projects = () => {
  ...
  const projects = [
    {
      title: "MedXpert",
      description: "A React Native web and mobile application made for inhancing tech and health for facilitating and making easy to access health care and making life more easy and enjoyable",
      imgUrl: projImg1,
    },
    {
